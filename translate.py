...
translation = ("a", "b", "v", "g", "d", "e", "e", "j", "z", "i", "j", "k", "l", "m", "n", "o", "p", "r",
               "s", "t", "u", "f", "h", "ts", "ch", "sh", "sch", "", "y", "", "e", "ju", "ja", "je", "i", "ji", "g",)
translations = {}
...
def normalize_names(name: str):
    ...
    try:
        for symbol in name.split(".")[0]:
            if (
                symbol.lower() not in cyrillic_symbols
                and symbol.lower() not in translation
                and symbol not in "1234567890cxwXCW"
            ):
                result += "_"
...
if __name__ == "__main__":
    print(normalize_names("русні пизда"))
